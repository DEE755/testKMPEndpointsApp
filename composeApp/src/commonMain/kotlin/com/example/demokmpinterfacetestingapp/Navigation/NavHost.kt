...
fun NavHost(
    ...
    promptFromUserSeriesScreen: @Composable (router: Router, questionList: List<String>, functionToExecute: () -> Unit) -> Unit
) {
    ...
    when (screen) {
        ...
        is Screen.PromptFromUserSeriesScreen -> {
            ...
            promptFromUserSeriesScreen(router, s.questionList ,s.functionToExecute)
        }
        else -> {}
    }
}